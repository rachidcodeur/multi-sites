...
const IMG_DEFAULTS = {
  hero:             path.join(__dirname, 'public', 'images', 'peintre-professionnel.webp'),
  'peinture-interieur': path.join(__dirname, 'public', 'images', 'images-services', 'peinture-interieur.webp'),
  'peinture-exterieur': path.join(__dirname, 'public', 'images', 'images-services', 'peinture-exterieur.webp'),
  'pose-papier-peint':  path.join(__dirname, 'public', 'images', 'images-services', 'pose-papier-peint.webp'),
};
