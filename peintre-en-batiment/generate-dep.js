...
[
  ...
  path.join(__dirname, 'public', 'images', 'peintre-professionnel.webp'),
  path.join(__dirname, 'public', 'images', 'images-services', 'peinture-interieur.webp'),
  path.join(__dirname, 'public', 'images', 'images-services', 'peinture-exterieur.webp'),
  path.join(__dirname, 'public', 'images', 'images-services', 'pose-papier-peint.webp'),
].forEach(src => {
